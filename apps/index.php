<?php 
	...
	$sql = "SELECT data_absen.uid, tanggal, nama, division,
		  ...
		  WHERE data_absen.uid=data_pengurus.uid  AND tanggal='".$today."'
...
<head>
  ...
  <link rel="icon" href="logo.PNG" type="image/x-icon">
    <!-- Alternatif untuk format PNG -->

  <title>BEM Fasilkom Unsika - Dashboard</title>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total pengurus</div>
